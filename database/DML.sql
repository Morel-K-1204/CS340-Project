...
INNER JOIN Decks AS Deck1 ON Matches.Deck1ID = Deck1.DeckID
INNER JOIN Decks AS Deck2 ON Matches.Deck2ID = Deck2.DeckID
INNER JOIN Players AS Player1 ON Deck1.PlayerID, = Player1.PlayerID
INNER JOIN Players AS Player2 ON Deck2.PlayerID, = Player2.PlayerID
